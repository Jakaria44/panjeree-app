...
// Mock data for subjects (matching Next.js structure)
        ...
        chapters: [
          {
            ...
            sections: [{ id: 'p1c1s1', name: 'পরিমাপের যন্ত্রপাতি' }],
          },
          {
            id: 'p1-c2',
            name: 'ভেক্টর',
          ...
          },
          {
            id: 'p1-c3',
            name: 'গতিবিদ্যা',
            sections: [{ id: 'p1c3s1', name: 'প্রাসের গতি' }],
          },
          {
            id: 'p1-c4',
            name: 'নিউটনিয়ান বলবিদ্যা',
            sections: [{ id: 'p1c4s1', name: 'বল ও তার প্রভাব' }],
          },
        ],
      },
      {
        ...
        chapters: [
          {
            id: 'p2-c1',
            name: 'তাপগতিবিদ্যা',
            sections: [{ id: 'p2c1s1', name: 'তাপগতিবিদ্যার সূত্র' }],
          },
          {
            id: 'p2-c2',
            name: 'স্থির তড়িৎ',
            sections: [{ id: 'p2c2s1', name: 'কুলম্বের সূত্র' }],
          },
        ],
      },
    ],
        ...
        chapters: [
          {
            id: 'ict-c1',
            name: 'সংখ্যা পদ্ধতি',
            sections: [{ id: 'ict-c1s1', name: 'বাইনারি ও দশমিক' }],
          },
          {
            id: 'ict-c2',
            name: 'ডিজিটাল ডিভাইস',
            sections: [{ id: 'ict-c2s1', name: 'লজিক গেট' }],
          },
        ],
      },
    ],
        ...
        chapters: [
          {
            ...
            sections: [{ id: 'ch1c1s1', name: 'নিরাপত্তা সরঞ্জাম' }],
          },
        ],
      },
      {
        ...
        chapters: [
          {
            id: 'ch2-c1',
            name: 'পরিবেশ রসায়ন',
            sections: [{ id: 'ch2c1s1', name: 'বায়ু দূষণ' }],
          },
        ],
      },
    ],
        ...
        chapters: [
          {
            id: 'b1-c1',
            name: 'কোষ ও এর গঠন',
            sections: [{ id: 'b1c1s1', name: 'কোষ প্রাচীর' }],
          },
        ],
      },
      {
        ...
        chapters: [
          {
            ...
            sections: [{ id: 'b2c1s1', name: 'শ্রেণিবিন্যাস' }],
          },
        ],
      },
    ],
